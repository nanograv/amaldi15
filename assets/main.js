	...
	// Container: container01.
		(function() {
			...
			new slideshowBackground('container01', {
				...
				images: [
					{
						src: 'assets/images/container01-c7d22616.jpg',
						position: 'center',
						motion: 'up',
						speed: 2,
						caption: 'Untitled',
	...
	// Slideshow: slideshow01.
		(function() {
			...
			new slideshowBackground('slideshow01', {
				...
				images: [
					{
						src: 'assets/images/slideshow01-672c86a5.jpg',
						position: 'center',
						motion: 'none',
						speed: 1,
						caption: 'Green Bank Telescope',
					},
					{
						src: 'assets/images/slideshow01-954f7643.jpg',
						position: 'center',
						motion: 'none',
						speed: 1,
						caption: 'VIRGO Detector',
					},
					{
						src: 'assets/images/slideshow01-f857336e.jpg',
						position: 'center',
						motion: 'none',
						speed: 1,
						caption: 'LISA Space Craft',
					},
					{
						src: 'assets/images/slideshow01-276cc696.jpg',
						position: 'center',
						motion: 'none',
						speed: 1,
						caption: 'LIGO Detector',
					},
				]
			});
